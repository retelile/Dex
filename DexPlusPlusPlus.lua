...
Main = (function()
	...
	Main.Init = function()
		...
		Main.LargeIcons:SetDict({
			Explorer = 0, Properties = 1, Script_Viewer = 2, Obfuscator_Icon = 9, SpyIcon = 10, LogIcon = 11, IYicon = 12, AudioIcon = 14, Watcher = 3, Output = 4, ScriptEdit = 5, Book = 6, Executor = 7, Object = 8, AnimationPreviewer = 16,
		})
